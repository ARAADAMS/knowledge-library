...
- [Munachiso Samuel Nwadike1,2](2606.26969.md)
- [Abstract. We prove an explicit formula for the generic rank of hypergeomet￾ric perverse sheaves on higher dimensional tori over a finite field, as defined](abstract._we_prove_an_explicit_formula_for_the_generic_rank_of_hypergeomet_ric_p.md)
- [Collaboration Capabilities: A Dichotomy of Backend](collaboration_capabilities_a_dichotomy_of_backend.md)
...
- [From Tokens to Latent States: Leveraging Pre-trained Language Models for](from_tokens_to_latent_states_leveraging_pre-trained_language_models_for.md)
- [Proceedings of Machine Learning Research vol 288:1–15, 2025 2nd International Conference on Neuro-symbolic Systems (NeuS)](proceedings_of_machine_learning_research_vol_288_1_15_2025_2nd_international_con.md)
